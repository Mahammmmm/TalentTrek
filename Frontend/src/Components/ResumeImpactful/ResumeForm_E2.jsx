...
const Questionnaire = () => {
  ...
  const educationData = location.state.educationData;
    ...
    const handleBack = (e) => {
        e.preventDefault();
        navigate("/ResumeFormEdu_Impactful",{state: personalDetailsData})  
        
        //window.location.href = "./ResumeFormEdu"
    };
    const handleNext = (e) => {
        e.preventDefault();
        navigate("/ResumeFormSkills_Impactful",{state: {personalDetailsData,workExperienceData,educationData}})  
        
       // window.location.href = "./ResumeFormSkills"
    };
    const handleAdd = (e) => {
        e.preventDefault();
        navigate("/ResumeFormEdu_Impactful",{state: {personalDetailsData,workExperienceData,educationData}})  
