...
const Questionnaire = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.data.status === 'ok') {
          ...
          navigate('/ResumeFormF_Impactful', { state: {personalDetailsData,workExperienceData,educationData,SkillsData,data} });
  ...
  const handleBack = (e) => {
    e.preventDefault();
    navigate('/ResumeFormSkills_Impactful', { state: personalDetailsData });
