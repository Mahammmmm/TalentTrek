...
const Questionnaire = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 'ok') {
        ...
        navigate('/ResumeFormS_Impactful', { state: {personalDetailsData,workExperienceData,educationData,data} });
      } else {
  ...
  const handleBack = (e) => {
    e.preventDefault();
    navigate('/ResumeFormEdu2_Impactful', { state: personalDetailsData });
