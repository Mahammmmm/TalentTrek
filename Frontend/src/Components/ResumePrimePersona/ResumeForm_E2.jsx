...
const Questionnaire = () => {
  ...
  const educationData = location.state.educationData;
    ...
    const handleBack = (e) => {
        e.preventDefault();
        navigate("/ResumeFormEdu",{state: personalDetailsData})  
        
        //window.location.href = "./ResumeFormEdu"
    };
    const handleNext = (e) => {
        e.preventDefault();
        navigate("/ResumeFormSkills",{state: {personalDetailsData,workExperienceData,educationData}})  
        
       // window.location.href = "./ResumeFormSkills"
    };
    const handleAdd = (e) => {
        e.preventDefault();
        navigate("/ResumeFormEdu",{state: {personalDetailsData,workExperienceData,educationData}})  
