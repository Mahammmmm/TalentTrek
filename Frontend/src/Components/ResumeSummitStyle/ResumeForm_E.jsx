...
const Questionnaire = () => {
    ...
    if (schoolName !== '' && schoolLocation !== '' && degree !== '' && fieldOfStudy !== '') {
      try {
        ...
        if (response.data.status === 'ok') {
          ...
          navigate("/ResumeFormEdu2_SummitStyle", { state: {personalDetailsData,workExperienceData,educationData} });
        } else {
  ...
  const handleBack = (e) => {
    e.preventDefault();
    navigate("/ResumeFormWorkExp2_SummitStyle",{state: personalDetailsData})  
