...
const Questionnaire = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.data.status === 'ok') {
          ...
          navigate('/ResumeFormF_SummitStyle', { state: {personalDetailsData,workExperienceData,educationData,SkillsData,data} });
  ...
  const handleBack = (e) => {
    e.preventDefault();
    navigate('/ResumeFormSkills_SummitStyle', { state: personalDetailsData });
