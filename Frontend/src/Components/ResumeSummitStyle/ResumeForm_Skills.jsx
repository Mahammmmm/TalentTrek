...
const Questionnaire = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 'ok') {
        ...
        navigate('/ResumeFormS_SummitStyle', { state: {personalDetailsData,workExperienceData,educationData,data} });
      } else {
  ...
  const handleBack = (e) => {
    e.preventDefault();
    navigate('/ResumeFormEdu2_SummitStyle', { state: personalDetailsData });
